...
def log_audio(path_to_file, audio_name=None, experiment=None):
    ...
    You can also download raw audio file to the local machine - use "three dots" located to the left from the player.
    ...
    Example:
        ...
        .. code:: python3
            ...
            log_audio('some-other-audio-file.mp3', 'my_audio')

    Note:
        Check out how the logged audio file looks in Neptune:
        `here <https://ui.neptune.ai/o/shared/org/showroom/e/SHOW-1473/artifacts?path=audio%2F&file=my_audio.html>`_.
    """
    ...
    html = """<!DOCTYPE html>
        ...
        </html>""".format(audio_name, encoded_sound.decode())
